        ...
        return(
          ...
          <Card>
            <CardItem header bordered style={{justifyContent:'center', alignContent:'center'}}>
              <Text style={{fontSize:20}}>Accident Insurance</Text>
            </CardItem>
          <CardItem bordered>
              <Body>
              <View>
                ...
                Health insurance is for hospitalization and life insurance compensates death. But, what if there is disability due to accident?
                </Text>
                <Text style={{fontSize:18, marginLeft:10}}>Benefits of having Accidental Insurance</Text>
                <Text>
                Family Security {'\n'}
                Family Security No Requirement of Documentation{'\n'}
            ...
            <View>
            <Text style={{ fontSize:18}}>What does the policy cover</Text>
               <Text>1. Accidental Death {'\n'}
